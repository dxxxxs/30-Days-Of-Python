...
def are_all_item_same_type(lst):
...
def most_spoken_languages():
    ...
    most_spoken = sorted(spoken_languages.items(),
...
def most_populated_countries():
    most_populated = sorted(
        countries, key=lambda x: x['population'], reverse=True)[:10]
